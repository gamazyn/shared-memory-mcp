...
export const DEFAULT_REDACT_SECRETS = false
export const DEFAULT_BACKUP_DIR = join(homedir(), ".shared-memory-mcp", "backups")
...
export const ENV_DEFAULTS = {
  ...
  SHARED_MEMORY_MCP_REDACT_SECRETS: String(DEFAULT_REDACT_SECRETS),
  SHARED_MEMORY_MCP_BACKUP_DIR: DEFAULT_BACKUP_DIR,
  SHARED_MEMORY_MCP_DEFAULT_NAMESPACE: DEFAULT_NAMESPACE
}
...
export function getRuntimeConfig(options = {}) {
  ...
  return {
    ...
    redactSecrets: parseBoolean(merged.SHARED_MEMORY_MCP_REDACT_SECRETS, DEFAULT_REDACT_SECRETS),
    backupDir: merged.SHARED_MEMORY_MCP_BACKUP_DIR || DEFAULT_BACKUP_DIR,
    defaultNamespace: merged.SHARED_MEMORY_MCP_DEFAULT_NAMESPACE || DEFAULT_NAMESPACE
  }
}
